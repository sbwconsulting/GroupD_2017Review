...
setwd("Z:/Favorites/CPUC10 (Group D - Custom EM&V)/4 Deliverables/00 - 2017 Evaluation/Database Review/E350 Data Additions/Raw Data Files")
...
twospd = grepl("two|Two|2", output$`Measure Description`, fixed = FALSE) & output$`Use Category` == "HVAC" 
...
#write out the file
write.csv(output, file = "Original EUL & RUL Export.csv")
